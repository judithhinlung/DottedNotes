 ...
 * application JAR.
 * <p>
 * This class is used by {@link XMLToScore} to avoid the XML parser going out
...
class MusicXMLEntityResolver implements org.xml.sax.EntityResolver {
  ...
  private static final Map<String, String> PUBLIC_ID_MAP = Collections.unmodifiableMap(
  ...
  public final InputSource resolveEntity(String publicID, String systemID)
    ...
    if (fileName != null) {
      ...
      if (inputStream != null) return new InputSource(inputStream);
    }
    return null;
  }
}
